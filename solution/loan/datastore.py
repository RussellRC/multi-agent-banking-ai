...
def datastore_search_tool(search_query: str):
    """
    Searches for the requested information about the Betty’s Bird Boutique store.
    ...
    try:
        ...
        logging.error(f"datastore_search_tool raised {type(e).__name__} unexpectedly! error: {e}")
